...
class GlobalImgui:
    ...
    def apply_style(self):
        self.style.colors[imgui.COLOR_WINDOW_BACKGROUND] = bpy.context.preferences.themes[0].user_interface.wcol_menu.inner
    ...
    def draw(self, CurrentSpaceType):
        ...
        io.font_global_scale = context.preferences.view.ui_scale * 2
        imgui.new_frame()
