...
def create_distribution(addon_root_path: str, dist_path: str):
    ...
    paths_to_remove = (
        ...
        "pywowlib/archives/casc/__pycache__",
        "pywowlib/archives/casc/include",
        "pywowlib/archives/casc/CASCLib",
        "pywowlib/archives/casc/lib",
        "pywowlib/archives/casc/casc.cpp",
        "pywowlib/archives/casc/setup.py",
        "pywowlib/archives/casc/cmake.py",
        "pywowlib/archives/casc/requirements.txt",
        ...
        "pywowlib/archives/mpq/native/include",
        "pywowlib/archives/mpq/native/lib",
